...
import com.api.Chat.model.json.request.AuthenticationRequest;
import com.api.Chat.model.json.response.AuthenticationResponse;
import com.api.Chat.model.security.CerberusUser;
import com.api.Chat.security.TokenUtils;
...
@RestController
@RequestMapping("${chat.route.authentication}")
public class AuthenticationController {

  private final Logger logger = Logger.getLogger(this.getClass());

  @Value("${chat.token.header}")
  ...
  @RequestMapping(value = "${chat.route.authentication.refresh}", method = RequestMethod.GET)
